...
from utils import (
    load_las, get_curve_mapping, process_data, extract_header_info,
    detect_depth_units, get_auto_scale, export_to_las
)
...
if uploaded_file:
    try:
        ...
        if est_pixels > 65000:
            ...
            with col4:
                # LAS Export
                las_data = export_to_las(df, header_info, f"{header_info['WELL']}_export.las", depth_unit)
                st.download_button(
                    label="📋 Export LAS",
                    data=las_data,
    ...
    <div style="text-align: center; padding: 60px 20px;">
        ...
        <h2 style="color: #00D4AA; margin-bottom: 10px;">Welcome to WellLog Analyzer Pro</h2>
